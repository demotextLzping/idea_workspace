...
public class DaoAspect2 {
    ...
    public void methodBefore() {
        System.out.println("methodBefore__2 invoked ... ...");
    }
    ...
    public void methodAfter() {
        System.out.println("methodAfter__2 invoked ... ...");
    }
    ...
    public void methodAfterReturning(JoinPoint joinPoint, Object res) {
        System.out.println("methodAfterReturning__2 invoked ... ...");
//        System.out.println(res);
    ...
    public void methodAfterThrowing(Exception ex) {
        System.out.println("methodAfterThrowing__2 invoked ... ...");
//        System.out.println(ex.getMessage());
    ...
    public Object methodAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        System.out.println("methodAroundA__2 invoked ... ... ");
        Object res = proceedingJoinPoint.proceed();  //控制切点方法在这里执行
        System.out.println("methodAroundB__2 invoked ... ... ");
        return res;
